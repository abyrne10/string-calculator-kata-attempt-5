...
describe('Calculator module', () => {
    describe('add', () => {
        ...
        it('should throw an error when a negative number is passed', () => {
            expect(() => { Calculator.add('1,2,-3,4'); }).to.throw(Error);
        });
        it('should have the negative numbers in the error message', () => {
        ...
        it('should return 10 when given "1,2,1001,3,4"', () => {
            expect(Calculator.add('1,2,1001,3,4')).to.equal(10);
        });
